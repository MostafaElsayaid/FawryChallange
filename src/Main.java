...
public class Main {
    public static void main(String[] args) {
        ...
        ExpirableShippableProduct cheese = new ExpirableShippableProduct("cheese",400,6, LocalDate.of(2025, 7, 10),400.0);
        ExpirableShippableProduct biscuits = new ExpirableShippableProduct(" Biscuits",700,6, LocalDate.of(2025, 7, 10),700.0);
        Cart cart = new Cart();
        cart.addItem(cheese,7);
